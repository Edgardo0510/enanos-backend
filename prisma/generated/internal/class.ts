...
/**
  ...
  /**
   * `prisma.enano`: Exposes CRUD operations for the **Enano** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Enanos
    * const enanos = await prisma.enano.findMany()
    * ```
    */
  get enano(): Prisma.EnanoDelegate<ExtArgs, { omit: OmitOpts }>;
}
